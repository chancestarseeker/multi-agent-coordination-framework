...
**Balance is reciprocal, not transactional.** The resource tracking below is a health indicator, not a billing system. It surfaces when the coordination field is under strain — not what any participant is "owed." The Three Sisters yield more than any could alone not because each "pays its share" but because each contributes what the others cannot. A routing algorithm that selects the cheapest capable participant is transactional; one that selects the participant whose engagement would most sustain the coordination's overall health is reciprocal.
